...
from _2_gerenciador_GUI import GerenciadorInterface
from _3_metodos_compressao import MetodoCompressao
...
class InterfaceGrafica(QMainWindow, MetodoCompressao):
    ...
    def init_ui(self):
        ...
        self.compression_method_layouts = {
            'rar': self.create_rar_layout,
            'zip': self.create_zip_layout,
            '7z': self.create_7z_layout,
            'tar.bz2': self.create_bzip2_layout,
            'zipx': self.create_zipx_layout,
            'tar.xz': self.create_tarxz_layout,
            'tgz': self.create_tgz_layout,
            'tar.gz': self.create_targz_layout,
            'lzh': self.create_lzh_layout,
            'iso': self.create_iso_layout,
        ...
        main_layout_1_widget.setMaximumHeight(175)
    ...
    def create_rar_layout(self):
        ...
        self.gerenciador_interface.output_listbox_rar.setMinimumHeight(95)
    ...
    def create_zipx_layout(self):
        ...
        self.gerenciador_interface.output_listbox_zipx.setMinimumHeight(95)
    ...
    def create_tarxz_layout(self):
        ...
        self.gerenciador_interface.output_listbox_tarxz.setMinimumHeight(95)
    ...
    def create_tgz_layout(self):
        ...
        self.gerenciador_interface.output_listbox_tgz.setMinimumHeight(95)
    ...
    def create_targz_layout(self):
        ...
        self.gerenciador_interface.output_listbox_targz.setMinimumHeight(95)
    ...
    def create_lzh_layout(self):
        ...
        self.gerenciador_interface.output_listbox_lzh.setMinimumHeight(95)
    ...
    def create_iso_layout(self):
        ...
        self.gerenciador_interface.output_listbox_iso.setMinimumHeight(95)
